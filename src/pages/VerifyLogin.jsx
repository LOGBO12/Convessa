      ...
      >
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-5 sm:p-8 border border-gray-200 relative overflow-hidden">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-whatsapp rounded-full flex items-center justify-center shadow-lg">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Code de connexion</h2>
            <p className="text-gray-600">Entrez le code envoyé sur WhatsApp</p>
            {phone && (
          ...
          {allFilled && !loading && (
            <button
              ...
              className="w-full mb-4 bg-whatsapp text-white py-3 rounded-xl font-semibold hover:bg-whatsapp-dark transition-all shadow-lg"
            >
              Se connecter
            </button>
          )}
